...
func buildRetentionOutputSchemaUnion() (json.RawMessage, error) {
	sumS, err := jsonschema.ForType(reflect.TypeOf(RetentionSummaryResponse{}), nil)
	if err != nil {
		return nil, err
	}
	...
	errS, err := jsonschema.ForType(reflect.TypeOf(RetentionCursorError{}), nil)
	if err != nil {
		return nil, err
	}
