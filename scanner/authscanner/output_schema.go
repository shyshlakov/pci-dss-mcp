...
func buildAuthOutputSchemaUnion() (json.RawMessage, error) {
	sumS, err := jsonschema.ForType(reflect.TypeOf(AuthSummaryResponse{}), nil)
	if err != nil {
		return nil, err
	}
	...
	errS, err := jsonschema.ForType(reflect.TypeOf(AuthCursorError{}), nil)
	if err != nil {
		return nil, err
	}
