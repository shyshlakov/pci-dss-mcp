...
func buildTLSOutputSchemaUnion() (json.RawMessage, error) {
	sumS, err := jsonschema.ForType(reflect.TypeOf(TLSSummaryResponse{}), nil)
	if err != nil {
		return nil, err
	}
	...
	errS, err := jsonschema.ForType(reflect.TypeOf(TLSCursorError{}), nil)
	if err != nil {
		return nil, err
	}
