...
func buildPANOutputSchemaUnion() (json.RawMessage, error) {
	sumS, err := jsonschema.ForType(reflect.TypeOf(PANSummaryResponse{}), nil)
	if err != nil {
		return nil, err
	}
	...
	errS, err := jsonschema.ForType(reflect.TypeOf(PANCursorError{}), nil)
	if err != nil {
		return nil, err
	}
