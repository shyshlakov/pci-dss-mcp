...
func buildAuditOutputSchemaUnion() (json.RawMessage, error) {
	sumS, err := jsonschema.ForType(reflect.TypeOf(AuditSummaryResponse{}), nil)
	if err != nil {
		return nil, err
	}
	...
	errS, err := jsonschema.ForType(reflect.TypeOf(AuditCursorError{}), nil)
	if err != nil {
		return nil, err
	}
